...
function Connect-GitHub {
    ...
    param(
        ...
        [Parameter()]
        [ValidateSet('repo', 'repo:status', 'repo_deployment', 'public_repo', 'repo:invite',
            ...
            'user:follow', 'project', 'read:project', 'delete_repo', 'write:packages',
            'read:packages', 'delete:packages', 'admin:gpg_key', 'write:gpg_key', 'read:gpg_key',
            'codespace', 'workflow')]
